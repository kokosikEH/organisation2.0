        ...
        <tr> 
          ...
          <td> 
            <a href="https://t.me/servan_t" target="_blank" draggable="false" display="false"> 
              <img src="/assets/ivan.png" className='left' draggable="false" width="100%" float="left" /> 
            </a> 
          </td> 
          <td> 
            <a href="https://t.me/KD_ATW" target="_blank" draggable="false" display="false"> 
              <img src="/assets/kirill.png"className='left' draggable="false" width="100%" float="left" /> 
            </a> 
          </td> 
          <td> 
