...
export default function Example() {
  ...
  return (
    <div className="isolate n-full bg-white h-full">
      ...
      <form onSubmit={handleOKClick} action="#" method="post" className="mx-auto mt-16 max-w-xl sm:mt-20">
        ...
        <div className="mt-10">
          <button
            type="submit"
            className="block w-full bg-gray-200  rounded-md bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
          >
            принять
          </button>
        </div>
